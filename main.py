...
if __name__ == '__main__':
    ...
    fiction = Fiction("Things Fall Apart", "Chinua Achebe", 7293740137)
    print(fiction.__repr__())

    society_of_mind = NonFiction("Society of Mind", "Artificial Intelligence", "beginner", 3487628932)
    ...
    non_fiction = NonFiction("Society of Mind", "Artificial intelligence", "beginner", 3487628932)
